      ...
      {signUp && allFieldsFilled && passwordsMatch ? (
        <div className="fixed top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 w-full md:w-[50dvw] xl:w-[25dvw] bg-background p-4 rounded text-md md:text-lg lg:text-xl z-50">
          ...
          <p className="mb-4">
            ...
            website as a substitute for professional medical advice, diagnosis,
            or treatment.
          </p>
          <p className="mb-4">
            The developers made every effort to provide accurate product
            information; however, it is subject to change. The label of product
            contains the most current information for the applicable formula.
            The developers do not endorse or recommend any specific product
      ...
      <div className="flex flex-col text-center items-center justify-center min-h-screen">
        ...
        <div className="flex flex-col w-fit h-fit bg-gradient-to-bl from-primary to-primary-600 justify-center text-white text-left items-center gap-6 p-4 md:p-8 rounded mb-4 xl:mb-[5dvh] shadow-2xl mx-1">
          <div className="flex flex-col w-full gap-2">
            <p className="text-4xl lg:text-5xl font-bold text-white">Sign Up</p>
