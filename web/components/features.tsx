// File: web/components/features.tsx
// Defines the Feature interface and exports the features array containing all application features.
// Used by the landing page to display feature cards with icons, titles, and descriptions.

// Interface defining the structure of a feature object
export interface Feature {
  icon: React.ReactNode; // React component or SVG element for the feature icon
  title: string; // Display name of the feature
  desc: string; // Description text explaining what the feature does
}

// Array of all features available in the Pediatric Blue Book application
